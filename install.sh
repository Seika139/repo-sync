...
cp "$SCRIPT_DIR/systemd/repo-sync-notify-failure.service" /etc/systemd/system/
cp "$SCRIPT_DIR/systemd/repo-sync-summary.service" /etc/systemd/system/
cp "$SCRIPT_DIR/systemd/repo-sync-summary.timer" /etc/systemd/system/
